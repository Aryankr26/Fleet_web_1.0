...
export function GeofencingPage() {
  ...
  const vehicles: Vehicle[] = [
    { id: 'TN-01-1234', status: 'inside', lat: 28.6139, lng: 77.2090, lastUpdated: '2 mins ago', distance: '50m from Office' },
    { id: 'TN-01-1236', status: 'inside', lat: 28.6150, lng: 77.2105, lastUpdated: '1 min ago', distance: '120m from Office' },
    { id: 'TN-01-1240', status: 'outside', lat: 28.6280, lng: 77.2240, lastUpdated: '5 mins ago', distance: '2.5km from Office' },
    { id: 'TN-01-1235', status: 'inside', lat: 28.6120, lng: 77.2080, lastUpdated: '3 mins ago', distance: '80m from Office' },
    { id: 'TN-01-1238', status: 'outside', lat: 28.6050, lng: 77.1990, lastUpdated: '7 mins ago', distance: '1.8km from Office' },
  ];

  // Convert vehicles to FleetMap format
  const fleetMapVehicles = vehicles.map(v => ({
    id: v.id,
    label: `${v.id} (${v.status})`,
    lat: v.lat,
    lng: v.lng,
    ...
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="absolute bottom-6 right-6 flex flex-col gap-2 z-[1200]">
        ...
        <div className="w-12 bg-white rounded-lg shadow-lg px-2 py-2 text-center">
          <span className="text-xs text-slate-700">Z:{mapZoom}</span>
        </div>
      </div>
          ...
          >
            ...
            <div className="p-6 overflow-y-auto max-h-[calc(95vh-100px)]">
              ...
              <div className="bg-[#F5F7FA] p-4 rounded-xl">
                ...
                {/* Map Display */}
                <div className="w-full h-[400px] rounded-lg border-2 border-[#E1E6EF] overflow-hidden">
                  <FleetMap 
                    className="w-full h-full"
                    center={[28.6139, 77.209]}
                    zoom={12}
